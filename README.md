...
`public/icons.json` lists every image under `public/images/`. It is generated by
`npm run icons:generate` (run automatically before start, build and test) and is git-ignored like
