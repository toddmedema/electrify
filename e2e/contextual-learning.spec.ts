...
test("reading help preserves the current tutorial objective", async ({
  ...
  // Mission 4, since Missions 1-3 keep the navigation to Insights hidden while they teach
  ...
  await page
    ...
    .click();
  await page
    .getByRole("button", { name: "Start Finances", exact: true })
    .click();
