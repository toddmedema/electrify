...
import {MenuItem, Select, Slider, Table, TableBody, TableCell, TableRow, Toolbar, Typography} from '@mui/material';
import ArrowDropDownIcon from '@mui/icons-material/ArrowDropDown';
import ArrowDropUpIcon from '@mui/icons-material/ArrowDropUp';
import {TICK_MINUTES, TICKS_PER_MONTH} from '../../Constants';
import {deriveExpandedSummary, EMPTY_HISTORY, getDateFromMinute, getTimeFromTimeline, reduceHistories, summarizeHistory, summarizeTimeline} from '../../helpers/DateTime';
              ...
              <TableBody>
                {Object.keys(CHART_KEYS).map((key: string) => {
                  ...
                  return (<TableRow className={!k.nesting ? 'bold' : `tabs-${k.nesting}`} key={key}>
                    ...
                    <TableCell align="right">{format(summary[key as DerivedHistoryKeysType])}</TableCell>
                  </TableRow>);
                })}
              </TableBody>
            </Table>
