import {DAYS_PER_MONTH, DAYS_PER_YEAR, GAME_TO_REAL_YEARS, MONTHS, TICK_MINUTES, TICKS_PER_HOUR} from '../Constants';
import {DateType, DerivedHistoryType, MonthlyHistoryType, MonthType, TickPresentFutureType} from '../Types';
